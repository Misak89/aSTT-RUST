...
**Cesta:** sandbox/TestDocu_a001/deterministic_docs_automation_plan_draft__sandbox_copy.md
**Original:** plans/deterministic_docs_automation_plan_draft.md
**Verze:** 0.5
**Vytvoreno:** 2026-02-25 07:21 (UTC+1)
**Posledni zmena:** 2026-02-25 12:43 (UTC+1)
**Status:** DRAFT - NEOFICIALNI (sandbox kopie pro test)

## Upozorneni

- Tento soubor je navrh.
- Neni SSOT.
- Jde o sandbox kopii pro oddelene testovani dokumentacniho konceptu.
- Oficialni navrh je `plans/deterministic_docs_automation_plan_draft.md`.
...
- [ ] Navrhnout `NEXT_SESSION` P0 hybrid-strong (ridici cast 100% JSON + kratka MD poznamka).
...
- `NEXT_SESSION` je v 0.4 navrzen jako `P0 hybrid-strong`; rozhodnout zbyva jen detaily implementace generatoru/validatoru.
