...
**Posledni zmena:** 2026-02-16 15:01 (UTC+1)
**Status:** SPRINT 1-7 DOKONCENY, KRITICKA ANALYZA PROVEDENA, NOVE UKOLY IDENTIFIKOVANY
...
- [ ] Sprint 8: Oprava kritickych problemu (P0)
...
### Sprint 8: Oprava kritických problémů (P0) ⚠️ NOVÉ
- [ ] Přidat CI kroky do workflow-steps.json
- [ ] Přepsat Husky hooks na PowerShell (nebo zajistit Git Bash kompatibilitu)
- [ ] Otestovat CI/CD pipeline s novými kroky

**Akceptacni kriteria:**
- [ ] CI/CD pipeline skutečně validuje projekt
- [ ] Husky hooks fungují na Windows bez Git Bash závislosti
- [ ] Všechny CI kroky projdou v GitHub Actions
